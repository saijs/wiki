...
![找不到成员。](../public/images/member-not-found.png)

而实际调试可以看到，ret 是有 `nodeValue` 属性的，值为 `null`。

![nodeValue](../public/images/nodeValue.png)

另外还有 `ie8_nodeValue` 和 `ie9_nodeValue` 属性。

![ie8_nodeValue](../public/images/ie8_nodeValue.png)

![ie9_nodeValue](../public/images/ie9_nodeValue.png)
